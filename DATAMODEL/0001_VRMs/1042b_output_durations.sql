...
SELECT "AnonomisedVRM", "GeometryID", "RestrictionTypeID", "RestrictionDescription", "RoadName", "SurveyAreaName", "SiteAreaName", b."SurveyDay", first AS "FirstSeen SurveyID", last AS "LastSeen SurveyID", span AS "Nr BeatsSeen", 
...
CASE WHEN ("first" IN (101, 201, 301) AND "span" = 1) THEN 'unknown'
     WHEN CEILING(b.span/2::float) > 12 THEN '>11 hours'
ELSE c."Description" 
END AS "DurationCategory"

FROM (

SELECT "AnonomisedVRM", "GeometryID", "RestrictionTypeID", "RestrictionDescription", "RoadName", "SurveyAreaName",  "SiteAreaName", "SurveyDay", first, last, last-first+1 As span, "UserTypeID"
...
SELECT DISTINCT ON ("AnonomisedVRM", "RoadName", "SurveyDay", first) 
		...
		first."SiteAreaName", first."SurveyDay", first."SurveyID" As first, last."SurveyID" AS last, first."UserTypeID"
FROM
    (SELECT v."AnonomisedVRM", v."GeometryID", su."RestrictionTypeID", su."Description", su."RoadName", su."SurveyAreaName", su."SiteAreaName", v."SurveyID", s."SurveyDay", v."UserTypeID"
    FROM demand."VRMs" v, demand."Surveys" s, 
	(SELECT s."GeometryID", s."RestrictionTypeID", l."Description", s."RoadName", "SurveyAreas"."SurveyAreaName", "SiteArea"."SiteAreaName"
	FROM (((mhtc_operations."Supply" s 
		LEFT JOIN toms_lookups."BayLineTypes" l ON s."RestrictionTypeID" = l."Code") 
...
SELECT v."AnonomisedVRM", v."GeometryID", su."RestrictionTypeID", su."Description", su."RoadName", su."SurveyAreaName", su."SiteAreaName", s."SurveyDay", v."SurveyID" As first, v."SurveyID" AS last, 1 AS span, v."UserTypeID"
    FROM demand."VRMs" v, demand."Surveys" s, 
	(SELECT s."GeometryID", s."RestrictionTypeID", l."Description", s."RoadName", "SurveyAreas"."SurveyAreaName", "SiteArea"."SiteAreaName"
	 FROM (((mhtc_operations."Supply" s 
		LEFT JOIN toms_lookups."BayLineTypes" l ON s."RestrictionTypeID" = l."Code") 
