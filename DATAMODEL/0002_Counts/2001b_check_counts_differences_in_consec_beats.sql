...
SELECT curr."Enumerator", curr."SurveyID", curr."GeometryID", s."RestrictionTypeID", l."Description", s."Capacity", curr."CapacityAtTimeOfSurvey"
,before."Demand" As "Demand - Before"
, curr."Demand" As "Demand - Current"
, after."Demand" As "Demand - After"
FROM demand."RestrictionsInSurveys" curr, demand."RestrictionsInSurveys" before, demand."RestrictionsInSurveys" after, mhtc_operations."Supply" s, toms_lookups."BayLineTypes" l
...
-- how to deal with first/last beats of the day 

-- first survey of day
SELECT curr."Enumerator", curr."SurveyID", curr."GeometryID", s."RestrictionTypeID", l."Description", s."Capacity", curr."CapacityAtTimeOfSurvey", curr."Demand" As "Demand - Current",
after."Demand" As "Demand - After"
FROM demand."RestrictionsInSurveys" curr, demand."RestrictionsInSurveys" after, mhtc_operations."Supply" s, toms_lookups."BayLineTypes" l
WHERE curr."GeometryID" = s."GeometryID"
AND s."RestrictionTypeID" = l."Code"
AND s."RestrictionTypeID" NOT IN (107, 109, 116, 117, 118, 119, 144, 147, 149, 150, 168, 169)
...
, before."Demand" As "Demand - Before"
, curr."Demand" As "Demand - Current"
FROM demand."RestrictionsInSurveys" curr, demand."RestrictionsInSurveys" before, mhtc_operations."Supply" s, toms_lookups."BayLineTypes" l
WHERE curr."GeometryID" = s."GeometryID"
AND s."RestrictionTypeID" = l."Code"
AND s."RestrictionTypeID" NOT IN (107, 109, 116, 117, 118, 119, 144, 147, 149, 150, 168, 169)
AND MOD(curr."SurveyID", 100) = y
AND curr."GeometryID" = before."GeometryID"
AND before."SurveyID" = curr."SurveyID" - 1
