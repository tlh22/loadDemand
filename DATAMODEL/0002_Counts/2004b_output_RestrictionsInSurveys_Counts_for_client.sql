...
d."SupplyCapacity", d."CapacityAtTimeOfSurvey", ROUND(d."Demand"::numeric, 2) AS "Demand", to_char(d."DemandSurveyDateTime" + interval '0' hour, 'Dy DD Mon HH24:MI') As "SurveyDateTime"
