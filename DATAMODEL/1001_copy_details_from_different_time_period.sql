...
DECLARE
    ...
    clone_restriction_id uuid;
    current_done BOOLEAN := false;
	wgs_survey_id INTEGER := 101;
	demand_survey_id INTEGER := 101;
BEGIN
    ...
    LOOP
        ...
        IF current_done IS false or current_done IS NULL THEN
            ...
            SELECT demand_survey_id, "SectionID", "GeometryID", "PositionID", "VRM", "VehicleTypeID", "RestrictionTypeID", "PermitTypeID", "Notes"
